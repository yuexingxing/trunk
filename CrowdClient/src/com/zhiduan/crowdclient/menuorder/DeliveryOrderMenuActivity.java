...
/**
 * 已接单菜单栏(待取件、配送中、已签收、异常件)
 * 
 * @author yxx
 * 
 * @date 2016-5-28 下午3:07:23
 * 
 */
public class DeliveryOrderMenuActivity extends Activity {

	private final String mPageName = "OrderMenuActivity";
	private Context mContext;
	private static DeliveryOrderMenuActivity orderMenuActivity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_delivery_order_menu_order);
	...
	protected void onResume() {
		super.onResume();
		setImmerseLayout(findViewById(R.id.layout_order_top));
	...
	private void findViewById() {
		...
		orderMenuActivity = DeliveryOrderMenuActivity.this;

		mEventBus = EventBus.getDefault();
		mEventBus.register(this);
		mContext = DeliveryOrderMenuActivity.this;
	...
	public void waitTaking(View v) {
		...
		MobclickAgent.onEvent(DeliveryOrderMenuActivity.this, "tv_order_wait");

		CURRENT_PAGE = 0;
		tvTitle1.setTextColor(getResources().getColor(R.color.main_color));
		tvTitle2.setTextColor(getResources().getColor(R.color.gray_4));
		tvTitle3.setTextColor(getResources().getColor(R.color.gray_4));
		tvTitle4.setTextColor(getResources().getColor(R.color.gray_4));
	...
	public void distribution(View v) {
		...
		MobclickAgent.onEvent(DeliveryOrderMenuActivity.this, "tv_order_sending");
		...
		CURRENT_PAGE = 1;
		tvTitle1.setTextColor(getResources().getColor(R.color.gray_4));
		tvTitle2.setTextColor(getResources().getColor(R.color.main_color));
		tvTitle3.setTextColor(getResources().getColor(R.color.gray_4));
		tvTitle4.setTextColor(getResources().getColor(R.color.gray_4));
	...
	public void signed(View v) {
		...
		MobclickAgent.onEvent(DeliveryOrderMenuActivity.this, "tv_order_signed");
		...
		tvTitle1.setTextColor(getResources().getColor(R.color.gray_4));
		tvTitle2.setTextColor(getResources().getColor(R.color.gray_4));
		tvTitle3.setTextColor(getResources().getColor(R.color.main_color));
		tvTitle4.setTextColor(getResources().getColor(R.color.gray_4));
	...
	public void abNormal(View v) {
		...
		MobclickAgent.onEvent(DeliveryOrderMenuActivity.this, "tv_order_abnormal");
		...
		tvTitle2.setTextColor(getResources().getColor(R.color.gray_4));
		tvTitle3.setTextColor(getResources().getColor(R.color.gray_4));
		tvTitle4.setTextColor(getResources().getColor(R.color.main_color));
...
//		}
	 ...
	 * @return
	 */
	public static DeliveryOrderMenuActivity getActivity() {
	...
	private void updateOrderMenuCount() {
		...
		RequestUtilNet.postDataToken(mContext, strUrl, jsonObject, new RequestCallback() {
			...
			public void callback(int success, String remark, JSONObject jsonObject) {
				...
				String strWait = getResources().getString(R.string.wait_take);
				String strMsg1 = String.format(strWait, count1);
				tvTitle1.setText(strMsg1);

				String strDis = getResources().getString(R.string.distribution);
				String strMsg2 = String.format(strDis, count2);
				tvTitle2.setText(strMsg2);

				String strSign = getResources().getString(R.string.signed);
				String strMsg3 = String.format(strSign, count3);
				tvTitle3.setText(strMsg3);

				String strAbnormal = getResources().getString(R.string.abnormal);
