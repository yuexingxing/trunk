...
import com.zhiduan.crowdclient.im.InviteMessage.InviteMesageStatus;
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                if(user != null){
                    if(EaseAtMessageHelper.get().isAtMeMsg(message)){
                        return String.format("aaa", user.getNick());
                    }
                    return user.getNick() + ": " + ticker;
                }else{
                    if(EaseAtMessageHelper.get().isAtMeMsg(message)){
                        return String.format("aaaaa", message.getFrom());
                    }
...
//		endCall();
		...
		EMClient.getInstance().logout(unbindDeviceToken, new EMCallBack() {
			...
			public void onSuccess() {
				Log.i("hexiuhui-----------", "onSuccessonSuccess");
			...
			public void onProgress(int progress, String status) {
				Log.i("hexiuhui-----------", "onProgressonProgressonProgress");
				if (callback != null) {
			...
			public void onError(int code, String error) {
				Log.i("hexiuhui-----------", "onErroronErroronErroronError");
				Log.d(TAG, "logout: onSuccess");
                reset();
				if (callback != null) {
