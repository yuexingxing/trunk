package com.zhiduan.crowdclient.wallet.widget;
...
//                mDateCalendarTextView.setText(" " + arry_date.get(wheel.getCurrentItem()));
    ...
    public void setTimePickerGone(boolean isGone) {
        ...
        if (isGone) {
            ...
            yearParams.leftMargin = 100;
            LinearLayout.LayoutParams dateParams = new LinearLayout.LayoutParams( LinearLayout.LayoutParams.MATCH_PARENT,
                    LinearLayout.LayoutParams.WRAP_CONTENT);
            mYearWheelView.setLayoutParams(yearParams);
            mDateWheelView.setLayoutParams(dateParams);
            dateParams.rightMargin = 22;
