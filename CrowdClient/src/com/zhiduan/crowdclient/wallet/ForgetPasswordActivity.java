...
private Context mContext;
	...
	public void initView() {
		...
		edtId = (EditText) findViewById(R.id.edt_forget_id);
		edtPhone = (EditText) findViewById(R.id.edt_forget_phone);
		edtCode = (EditText) findViewById(R.id.edt_forget_code);
		
		btnCode = (Button) findViewById(R.id.btn_forget_code);
	...
	private void checkStatus(){
		...
		if(strId.length() < 15 || strPhone.length() != 11 || strCode.length() != 6){
	...
	public void nextStep(View v){
		...
		Intent intent = new Intent(this, SettingTradePwdActivity.class);
		String strId = edtId.getText().toString();
		String strPhone = edtPhone.getText().toString();
		String strCode = edtCode.getText().toString();
	...
	class TimeCount extends CountDownTimer {
		...
		public void onTick(long millisUntilFinished) {// 计时过程显示
			...
			spanStack.setSpan(new ForegroundColorSpan(Color.RED), 0, spanStack.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
