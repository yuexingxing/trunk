 ...
 * 
 */
public class AlterPassWord2Activity extends BaseActivity implements
				...
				if (text.length() == length) {
					...
					case 6:
						mEt6.setText(text.subSequence(text.length() - 1,
								text.length()));
						length = text.length();
						Intent intent = new Intent(AlterPassWord2Activity.this,
								AlterPassWord3Activity.class);
