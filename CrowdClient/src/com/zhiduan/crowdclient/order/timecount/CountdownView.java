package com.zhiduan.crowdclient.order.timecount;
...
public class CountdownView extends View {
    ...
    public void start(long millisecond) {
        ...
        mCustomCountDownTimer = new CustomCountDownTimer(millisecond, countDownInterval) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Logs.v("timecount", "CustomCountDownTimer : " + millisUntilFinished / 1000 + "");
            }
            ...
            public void onFinish() {
                ...
                Logs.v("timecount", "倒计时结束");
                CommandTools.showToast("toast000");
            }
        };
    ...
    public void updateShow(long ms) {
        ...
        if (null != mOnCountdownEndListener && ms < 1000) {//倒计时为0时，发起结束回调
            mOnCountdownEndListener.onEnd(CountdownView.this);
        }
    }
