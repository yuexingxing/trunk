...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected void initView() {
    	title_center = (TextView) getView().findViewById(R.id.title_center);
    ...
    protected void setUpView() {
    	title_center.setText(toChatUsername);
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            // set title
            if(EaseUserUtils.getUserInfo(toChatUsername) != null){
                EaseUser user = EaseUserUtils.getUserInfo(toChatUsername);
                if (user != null) {
                	title_center.setText(user.getNick());
                }
            }
        } else {
            if (chatType == EaseConstant.CHATTYPE_GROUP) {
                ...
                if (group != null)
                	title_center.setText(group.getGroupName());
        ...
        title_center.setOnClickListener(new OnClickListener() {
...
//        title_center.setRightLayoutClickListener(new OnClickListener() {
//
//            @Override
//            public void onClick(View v) {
//                if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            public void onSuccess(final EMChatRoom value) {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (room != null) {
                        	title_center.setText(room.getName());
...
//            }
			...
			@Override
			public void onAdminAdded(String arg0, String arg1) {
				// TODO Auto-generated method stub
				
			}

			@Override
			public void onAdminRemoved(String arg0, String arg1) {
				// TODO Auto-generated method stub
				
			}

			@Override
			public void onMuteListAdded(String arg0, List<String> arg1,
					long arg2) {
				// TODO Auto-generated method stub
			...
			@Override
			public void onMuteListRemoved(String arg0, List<String> arg1) {
				// TODO Auto-generated method stub
				
			}

			@Override
			public void onOwnerChanged(String arg0, String arg1, String arg2) {
				// TODO Auto-generated method stub
				
			}

			@Override
			public void onRemovedFromChatRoom(String arg0, String arg1,
					String arg2) {
				// TODO Auto-generated method stub
    ...
    class GroupListener extends EaseGroupRemoveListener {
		...
		@Override
		public void onMuteListAdded(String arg0, List<String> arg1, long arg2) {
			// TODO Auto-generated method stub
		...
		@Override
		public void onRequestToJoinAccepted(String arg0, String arg1,
				String arg2) {
			// TODO Auto-generated method stub
		...
		@Override
		public void onRequestToJoinDeclined(String arg0, String arg1,
		...
		@Override
		public void onRequestToJoinReceived(String arg0, String arg1,
				String arg2, String arg3) {
			// TODO Auto-generated method stub
